...
//OTP Login api
export const OTPLOGIN_PENDING = 'OTPLOGIN_PENDING';
export const OTPLOGIN_ERROR = 'OTPLOGIN_ERROR';
export const OTPLOGIN_SUCCESS = 'OTPLOGIN_SUCCESS';
...
export const EXPRESSSERVICE = 'EXPRESSSERVICE';
